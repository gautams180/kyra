...
export const ProfileBio: React.FC<any> = ({ profileData }) => {
  return (
    <div className="w-11/12 mx-auto p-8 rounded-3xl flex flex-col gap-5 border-[1px] border-gray">
      <h1 className="text-2xl font-bold font-oswald">Profile Bio</h1>
      <div className="flex gap-8">
        <div className="flex gap-1 items-center px-2 rounded-lg bg-[#212529] text-xs lg:text-sm cursor-pointer">
          ...
          <p>@{socialHandlesData[0].handle}</p>
        </div>
